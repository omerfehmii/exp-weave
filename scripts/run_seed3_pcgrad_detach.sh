...
if [ ! -f "${SUMMARY}" ]; then
  echo "run_name,model,seed,config,checkpoint_best_loss,checkpoint_best_dir,checkpoint_last,best_loss_mae,best_loss_pinball,best_loss_coverage90,best_loss_width90,best_loss_aci_coverage90,best_loss_aci_width90,best_loss_dir_wMCC,best_loss_dir_wAUC,best_loss_dir_acc_mean,best_loss_dir_mcc_mean,best_loss_dir_auc_mean,best_loss_boot_h1_acc,best_loss_boot_h1_mcc,best_loss_boot_h24_acc,best_loss_boot_h24_mcc,best_dir_mae,best_dir_pinball,best_dir_coverage90,best_dir_width90,best_dir_aci_coverage90,best_dir_aci_width90,best_dir_dir_wMCC,best_dir_dir_wAUC,best_dir_dir_acc_mean,best_dir_dir_mcc_mean,best_dir_dir_auc_mean,best_dir_boot_h1_acc,best_dir_boot_h1_mcc,best_dir_boot_h24_acc,best_dir_boot_h24_mcc,last_mae,last_pinball,last_coverage90,last_width90,last_aci_coverage90,last_aci_width90,last_dir_wMCC,last_dir_wAUC,last_dir_acc_mean,last_dir_mcc_mean,last_dir_auc_mean,last_boot_h1_acc,last_boot_h1_mcc,last_boot_h24_acc,last_boot_h24_mcc" > "${SUMMARY}"
fi
...
row = [
    ...
    fore_bl.get("mae"),
    fore_bl.get("pinball"),
    fore_bl.get("coverage90"),
    fore_bl.get("width90"),
    aci_bl.get("coverage90"),
    aci_bl.get("width90"),
    ...
    fore_bd.get("mae"),
    fore_bd.get("pinball"),
    fore_bd.get("coverage90"),
    fore_bd.get("width90"),
    aci_bd.get("coverage90"),
    aci_bd.get("width90"),
    ...
    "entries": [
        {
            ...
            "metrics": {
                ...
                "coverage90": fore_bl.get("coverage90"),
                "width90": fore_bl.get("width90"),
                "aci_coverage90": aci_bl.get("coverage90"),
                "aci_width90": aci_bl.get("width90"),
        ...
        },
        {
            ...
            "metrics": {
                ...
                "coverage90": fore_bd.get("coverage90"),
                "width90": fore_bd.get("width90"),
                "aci_coverage90": aci_bd.get("coverage90"),
                "aci_width90": aci_bd.get("width90"),
        ...
        },
        {
            ...
            "metrics": {
                ...
                "coverage90": fore_l.get("coverage90"),
                "width90": fore_l.get("width90"),
                "aci_coverage90": aci_l.get("coverage90"),
                "aci_width90": aci_l.get("width90"),
